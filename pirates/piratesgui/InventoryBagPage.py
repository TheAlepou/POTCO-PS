...
class InventoryBagPage(InventoryPage.InventoryPage):
    ...
    def __init__(self, inventoryUIManager):
        ...
        self.weaponBag = self.addContainer(InventoryUIWeaponContainer.InventoryUIWeaponContainer(self.inventoryUIManager, self.buttonSize * 6.0, self.buttonSize * 5.0, 6, 5, slotList = list(range(Locations.RANGE_WEAPONS[0], Locations.RANGE_WEAPONS[0] + 30))))
        self.clothingBag = self.addContainer(InventoryUIClothingContainer.InventoryUIClothingContainer(self.inventoryUIManager, self.buttonSize * 5.0, self.buttonSize * 7.0, 5, 7, slotList = list(range(Locations.RANGE_CLOTHES[0], Locations.RANGE_CLOTHES[0] + 35))))
        self.jewelryBag = self.addContainer(InventoryUIJewelryContainer.InventoryUIJewelryContainer(self.inventoryUIManager, self.buttonSize * 4.0, self.buttonSize * 7.0, 4, 7, slotList = list(range(Locations.RANGE_JEWELERY_AND_TATTOO[0], Locations.RANGE_JEWELERY_AND_TATTOO[0] + 28))))
        cardRange = list(range(UberDogGlobals.InventoryType.begin_Cards, UberDogGlobals.InventoryType.end_Cards))
        cardRange.reverse()
        self.potionBag = self.addContainer(InventoryUIConsumableContainerLocatable.InventoryUIConsumableContainerLocatable(self.inventoryUIManager, self.buttonSize * 6.0, self.buttonSize * 7.0, 6, 7, slotList = list(range(Locations.RANGE_CONSUMABLE[0], Locations.RANGE_CONSUMABLE[0] + 42))))
        ...
        self.inventoryPanelDressing = InventoryUIDressingContainer.InventoryUIDressingContainer(self.inventoryUIManager, self.buttonSize, self.buttonSize * 7.0, slotList = list(range(Locations.RANGE_EQUIP_CLOTHES[0], Locations.RANGE_EQUIP_CLOTHES[1] + 1)))
        self.inventoryPanelDressing.setPos(-0.22500000000000001, 0.0, -0.0)
        self.inventoryPanelDressing.reparentTo(self.clothingBag)
        self.inventoryPanelJewelryDressing = InventoryUIJewelryDressingContainer.InventoryUIJewelryDressingContainer(self.inventoryUIManager, self.buttonSize * 2.0, self.buttonSize * 4.0, slotList = list(range(Locations.RANGE_EQUIP_JEWELRY[0], Locations.RANGE_EQUIP_JEWELRY[1] + 1)))
        ...
        self.inventoryPanelTattooDressing = InventoryUITattooDressingContainer.InventoryUITattooDressingContainer(self.inventoryUIManager, self.buttonSize * 2.0, self.buttonSize * 2.0, slotList = list(range(Locations.RANGE_EQUIP_TATTOO[0], Locations.RANGE_EQUIP_TATTOO[1] + 1)))
