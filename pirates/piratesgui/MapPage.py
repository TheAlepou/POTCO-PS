...
class MapPage(InventoryPage.InventoryPage):
    ...
    def createWorldMap(self):
        ...
        if __dev__ and 0:
            ...
            self.mouseModeLabel = DirectLabel(parent = self, scale = 0.074999999999999997, pos = (0.5, 0, 0.086999999999999994), text = repr(self.worldMap.mapBall.rMode), text_fg = (1, 1, 1, 1), textMayChange = 1)
